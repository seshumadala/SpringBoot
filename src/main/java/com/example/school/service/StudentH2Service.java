...
return savedStudent;
    ...
    public Student updateStudent(int studentId, Student student) {
        ...
        if (student.getGender() != null) {
            db.update("update a student set Gender=? where studentId=?", student.getGender(), studentId);
        }
        if (student.getStandard() != 0) {
            db.update("update a student set standard=? where studentId=?", student.getStandard(), studentId);
        }
